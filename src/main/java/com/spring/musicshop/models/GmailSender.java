...
public class GmailSender {
    private static String SENDER_EMAIL = "nguyenloc2202@gmail.com";
    private static String SENDER_EMAIL_PWD = "kingeric11";
    ...
    public static void send(String to, String subject, String body, boolean bodyIsHTML)
        ...
        Address fromAddress = new InternetAddress(SENDER_EMAIL, "Musical Instrument Shop");
